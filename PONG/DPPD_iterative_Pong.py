...
from model import PongTargetNet, StudentPong
...
def main():
    ...
    plot_graph(data=accuracy_vs_size, name=FLAGS.DPPD_dir + "/accuracy_vs_size", figure_num=iteration + 1, xaxis='NNZ params', yaxis='Accuracy')
